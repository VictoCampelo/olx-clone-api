...
CREATE TABLE `users` (
    ...
    `password-hash` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `immages` ADD CONSTRAINT `immages_adId_fkey` FOREIGN KEY (`adId`) REFERENCES `ads`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
